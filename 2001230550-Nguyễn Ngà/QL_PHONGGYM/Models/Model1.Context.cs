...
namespace QL_PHONGGYM.Models
{
    ...
    public partial class QL_PHONGGYMEntities : DbContext
    {
        ...
        [DbFunction("QL_PHONGGYMEntities", "f_GetKhachHangHetHanTrongTuan")]
        public virtual IQueryable<f_GetKhachHangHetHanTrongTuan_Result> f_GetKhachHangHetHanTrongTuan()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<f_GetKhachHangHetHanTrongTuan_Result>("[QL_PHONGGYMEntities].[f_GetKhachHangHetHanTrongTuan]()");
        }
        ...
        public virtual int sp_SuaLichTapPT(Nullable<int> maLichPT, Nullable<int> maDKPT, Nullable<System.DateTime> ngayTap, Nullable<System.TimeSpan> gioBatDau, Nullable<System.TimeSpan> gioKetThuc, string trangThai)
        {
            var maLichPTParameter = maLichPT.HasValue ?
                new ObjectParameter("MaLichPT", maLichPT) :
                new ObjectParameter("MaLichPT", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_SuaLichTapPT", maLichPTParameter, maDKPTParameter, ngayTapParameter, gioBatDauParameter, gioKetThucParameter, trangThaiParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> sp_SuaSanPham(Nullable<int> maSP, string tenSP, Nullable<int> maLoaiSP, Nullable<decimal> donGia, Nullable<int> soLuongTon, Nullable<decimal> giaKhuyenMai, string hang, string xuatXu, string baoHanh, string moTaChung, string moTaChiTiet)
        {
            var maSPParameter = maSP.HasValue ?
                new ObjectParameter("MaSP", maSP) :
                new ObjectParameter("MaSP", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("sp_SuaSanPham", maSPParameter, tenSPParameter, maLoaiSPParameter, donGiaParameter, soLuongTonParameter, giaKhuyenMaiParameter, hangParameter, xuatXuParameter, baoHanhParameter, moTaChungParameter, moTaChiTietParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> sp_XoaLoaiSanPham(Nullable<int> maLoaiSP)
        {
            var maLoaiSPParameter = maLoaiSP.HasValue ?
                new ObjectParameter("MaLoaiSP", maLoaiSP) :
                new ObjectParameter("MaLoaiSP", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("sp_XoaLoaiSanPham", maLoaiSPParameter);
        }
